                    ...
                    <tbody>
                        <tr v-for="institution in institutions">
                            ...
                            <td class="py-3">
                                ...
                                <a class='btn btn-sm btn-dark' :title="lang.reset_users" href='#' @click.prevent='resetUsers(institution.id)'><i class="fas fa-user-slash"></i></a>
                                <!-- <i class="fas fa-key"></i><i class="fas fa-lock"></i><i class="fas fa-download"></i> -->
                            </td>
                        </tr>
                    </tbody>
                </table>

                <!-- <p><a class='btn btn-success' href='#'>{{ lang.add }}</a></p> -->
            </div>
        </div>
    </div>
</template>
