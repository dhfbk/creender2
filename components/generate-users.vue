                ...
                <form class="form" role="form" @submit.prevent="$emit('passdata', info, instid)">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="usersPerPhoto" class="col-form-label">{{ lang.users_per_photo }}:</label>
                        ...
                        <div class="form-group">
                            <label for="userGroups" class="col-form-label">{{ lang.user_groups }}</label>:</label>
                        ...
                        <div class="form-group">
                            <label for="debugPhotos" class="col-form-label">{{ lang.debug_photos }}</label>:</label>
                        ...
                        <div class="form-group">
                            <label for="filesFolder" class="col-form-label">{{ lang.files_folder }}</label>:</label>
